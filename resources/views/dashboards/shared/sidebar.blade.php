    ...
    <div class="scrollbar" data-simplebar>
        ...
        <ul class="side-nav">
            ...
            <li class="side-nav-item has-sub-menu">
                <a href="javascript:void(0);" class="side-nav-link" onclick="toggleSystemBasicsMenu(event)" role="button" aria-expanded="false" aria-controls="sub-menu-system-basics">
